class PwaGate extends HTMLElement {
  ...
  detectSupport() {
    ...
    // On iOS, only Safari supports PWA — detect it precisely
    const isSafari = /Safari/.test(ua) && !/Chrome|CriOS|FxiOS|Brave|OPR|Edg/.test(ua);
    ...
    return {
      ...
      isFirefox, isSamsungBrowser, isEdge,
