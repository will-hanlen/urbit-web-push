  ...
  getInstructions(s, appName) {
    ...
    if (s.isIOS && !s.isSafari) {
      return {
        ...
        items: [
          `Tap <strong>Share</strong> ${this.shareIcon()} then <strong>"Add to Home Screen"</strong>`,
        ],
        warn: null,
      };
    }
    ...
    if (s.isAndroid && s.isFirefox) {
      return {
        ...
        items: [
          `Tap <strong>\u22ee</strong> menu then <strong>"Install app"</strong>`,
        ],
        warn: null,
      };
    }
    ...
    if (s.isAndroid && s.isSamsungBrowser) {
      return {
        subtitle: "Install as an app to continue.",
        items: [
          `Tap <strong>\u2630</strong> menu then <strong>"Add page to" \u2192 "Home screen"</strong>`,
        ],
        warn: null,
      };
    }
    ...
    if (s.isSafari) {
      return {
        subtitle: "Install as an app to continue.",
        items: [
          `Go to <strong>File \u2192 Add to Dock</strong>`,
        ],
    ...
    if (s.isFirefox) {
      return {
        subtitle: "Install as an app to continue. Open in <strong>Chrome</strong> or <strong>Edge</strong>.",
        items: [
    ...
    // Unknown browser
    return {
      subtitle: "Install as an app to continue. Open in <strong>Chrome</strong>, <strong>Edge</strong>, or <strong>Safari</strong>.",
      items: [
        `Use the browser's install option`,
      ],
      warn: null,
