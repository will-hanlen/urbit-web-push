class PwaGate extends HTMLElement {
  ...
  detectSupport() {
    ...
    // On iOS, only Safari supports PWA install. navigator.standalone exists
    // only in Safari — non-Safari browsers (Brave, Chrome, Firefox) that
    // mimic Safari's UA string will have it undefined.
